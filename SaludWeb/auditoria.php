...
<body>
    ...
    <a href="lista">← Volver al Dashboard</a><br><br>
    <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php if (strpos($l['accion'], 'papelera') !== false): 
                        ...
                        <a href="restaurar?id=<?php echo $id; ?>" style="color: green; font-weight: bold; margin-left: 20px; text-decoration: none;">[♻️ Restaurar]</a>
                    <?php endif; ?>
                </td>
            </tr>
            <?php endforeach; ?>
